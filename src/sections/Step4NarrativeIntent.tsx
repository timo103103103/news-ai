...
export default function Step4NarrativeIntent({
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      ====================================================== */}
      <div className="relative overflow-hidden rounded-xl border border-blue-200 dark:border-blue-500/30 bg-gradient-to-br from-blue-50 to-slate-50 dark:bg-slate-950 p-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="rounded-md border border-blue-200 bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-blue-700 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-300">
            Confidence: {dominant?.confidence ?? 0}%
          </span>
        </div>

        <p className="mt-4 border-l-2 border-blue-200 pl-4 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
        ...
        <div className="px-6 pb-6 space-y-8">
          ...
          {!isPremium ? (
            <div className="rounded-xl border border-dashed p-6 text-center text-sm text-slate-500">
              Advanced narrative analysis is available on Pro / Business plans.
            </div>
          ) : (
            <>
              {/* ======================================================
              ...
              {/* ======================================================
                  POWER AMPLIFICATION
              ====================================================== */}
              {strategyIntent?.powerAmplification?.actors?.length > 0 && (
                <PowerAmplificationMap
                  actors={strategyIntent.powerAmplification.actors}
                />
              )}
            </>
          )}
