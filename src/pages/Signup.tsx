...
export default function Signup() {
  ...
  const { signUp, signInWithOAuth, loading, error, clearError, isAuthenticated } = useAuthStore()
  ...
  const validateForm = () => {
    const newErrors: { email?: string; password?: string; confirmPassword?: string; terms?: string } = {}
