...
interface AnalysisData {
  ...
  marketImpact?: {
    ...
    tickers: Array<{
      ...
      tier: 'Direct' | 'Indirect' | 'Speculative';
      confidence: number;
      trapWarning?: boolean;
      reasoning: string;
    }>;
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          >
            {isPremium ? (
              ...
              analysisData?.marketImpact ? (
                <StockImpactMeter data={analysisData.marketImpact} />
              ) : (
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
          ...
          {/* Chronos Isomorphism - Historical Pattern Matching */}
          {analysisData?.chronos && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.8 }}
            >
              <ChronosIsomorphism data={analysisData.chronos} />
            </motion.div>
          )}

          {/* Thermodynamic Entropy - Signal vs Noise */}
          {analysisData?.entropy && (
            ...
            >
              <ThermodynamicEntropy data={analysisData.entropy} />
            </motion.div>
          )}
